...
OPENAI_SERVICE_URL = os.environ.get("OPENAI_SERVICE_URL", "http://openai_service:5010/openai")
...
def location_recommendation():
    ...
    try:
        ...
        if openai_response.status_code == 200:
            response_text = openai_response.json().get("choices", [{}])[0].get("message", {}).get("content", "").strip()
